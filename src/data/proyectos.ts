...
export const proyectos: Proyecto[] = [
  {
    ...
    imagenPrincipal: '/images/proyectos/los-incas-card.jpg',
    imagenes: [],
    heroImage: '/images/los-incas/render-11-v3-1.png',
    mainImage: '/images/los-incas/render-01-noche-3.png',
    portraitImage: '/images/los-incas/render-16-2.png',
    gridImages: [
      '/images/los-incas/render-05-2.png',
      '/images/los-incas/render-04-2.png',
  ...
  },
  {
    ...
    portraitImage: '/images/los-incas/render-16-2.png',
    gridImages: [
      '/images/otros/img-42.png',
      '/images/otros/img-31.png',
      '/images/otros/img-92.png',
      '/images/otros/img-72.png',
    ],
    galeriaImages: [
      '/images/los-incas/render-07-2.png',
      '/images/los-incas/render-09-2.png',
  ...
  },
  {
    ...
    imagenPrincipal: '/images/proyectos/oficinas-sucre-card.jpg',
    imagenes: [],
    heroImage: '/images/proyectos/oficinas-sucre-card.jpg',
    mainImage: '/images/otros/img-12.jpg',
    portraitImage: '/images/los-incas/render-16-2.png',
    gridImages: [
      '/images/otros/img-42.png',
